          ...
          <v-row class="ma-0 justify-center">
            <v-col cols="4" class="d-none d-md-block">
              ...
              <div class="pa-5 pr-3 mt-10 mr-5">
                <v-btn
                  text="دنبال کردن"
                  color="light-blue-lighten-2 font-weight-light rounded-btn"
                  size="x-large"
                ></v-btn>
              </div>
            </v-col>
              ...
              <div class="av-holder">
                <div class="profile-av-img">
                  <v-img
                    ...
                    cover
                    src="https://picsum.photos/250/300?image=100"
                    :aspect-ratio="1 / 1"
                    width="180"
                  ></v-img>
                </div>
              ...
              <div class="d-flex flex-column justify-space-between h-100 pb-5">
                ...
                <div class="text-left pl-5">
                  ...
                  <v-btn
                    flat
                    color="#1e2124"
                    class="mr-2 text-light-blue-lighten-2 counter-btn"
                    height="40"
            ...
            <v-col cols="12" class="d-block d-md-none">
              <v-divider
                color="light-blue-lighten-2"
                :thickness="1"
                class="mx-5 border-opacity-100 mb-5"
              ></v-divider>
            ...
            <div class="mt-15 px-3">
              <v-card elevation="0" class="question-card" v-for="q in 3" :key="q">
                <div class="pa-md-10 pa-3">
                  ...
                  <div class="mt-5">
                    <span class="font-weight-medium" style="font-size: 1.25rem"
                      >عنوان پرسش</span
                    >
                  </div>
                  <div class="mt-5">
