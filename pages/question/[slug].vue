  ...
  <div>
        ...
        <div class="pa-md-10 pa-3">
          <div class="d-flex justify-space-between align-center">
              ...
              <div class="">
                <div class="d-flex align-center">
                  ...
                  <div class="mr-4" style="width: 200px; word-break: break-all; white-space: normal">
                    <span class="" style="font-size: 1.4rem"> پریا سهیلی </span>
                  </div>
                </div>
                <div>
                  <div class="d-sm-none mt-4 d-flex align-center">
                    ...
                    <div>
                      <v-btn flat :color="useCookie('theme').value == 'myLight' ? '#F9FBFC' : '#1e2124'
                        " :class="[
                          useCookie('theme').value == 'myLight'
                            ? 'has-border'
                            : 'no-border',
                          'text-light-blue-lighten-2 mr-2 counter-btn',
                        ]" height="40" text="160">
            ...
            <div class="d-sm-flex d-none align-center">
              ...
              <div>
                <v-btn flat :color="useCookie('theme').value == 'myLight' ? '#F9FBFC' : '#1e2124'" :class="[
                  useCookie('theme').value == 'myLight' ? 'has-border' : 'no-border',
                  'text-light-blue-lighten-2 mr-2 counter-btn',
                ]" height="40" text="160">
                  <template v-slot:prepend>
          ...
          <div class="mt-5">
            <span class="font-weight-medium" style="font-size: 1.25rem">عنوان پرسش</span>
          </div>
          <div class="mt-5">
            <p class="text-body-1">
              ...
              ابزارهای کاربردی می باشدلورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از
          ...
          <div class="mt-5">
            <div class="chip text-body-2 ml-3 px-3 py-2 border rounded-pill">
              #طراحی_وب
            </div>
            <div class="chip text-body-2 ml-3 px-3 py-2 border rounded-pill">
              #فرانت_اند
          ...
          <div class="mt-8 d-flex justify-space-between align-center">
            ...
            <div class="d-flex align-center">
              <v-btn flat :color="useCookie('theme').value == 'myLight' ? '#F9FBFC' : '#1e2124'" :class="[
                useCookie('theme').value == 'myLight' ? 'has-border' : 'no-border',
                'text-light-blue-lighten-2 counter-btn',
              ]" height="40" text="4">
                <template v-slot:prepend>
            ...
            <div class="d-none d-sm-block">
              <v-btn text="پاسخ" :class="[
                useCookie('theme').value == 'myLight' ? 'tonal-bg' : '',
                'reply-btn',
              ]" size="x-large" variant="outlined" color="light-blue-lighten-2">
                <template v-slot:append>
                  <img :src="useCookie('theme').value == 'myLight'
                    ? '/icons/reply-outline.svg'
                    : '/icons/reply-fill.svg'
          ...
          <v-btn text="پاسخ" :class="[
            useCookie('theme').value == 'myLight' ? 'tonal-bg' : '',
            'reply-btn mt-8 d-flex d-sm-none',
    ...
    <div class="pt-15">
      <v-row class="ma-0 mt-15">
        ...
        <v-col cols="12" lg="9">
          <v-card v-for="q in 5" :key="q" flat :class="[
            useCookie('theme').value == 'myLight' ? 'has-border' : 'no-border',
            'question-card',
          ]">
            <div v-if="q % 2 == 0" :class="[
              useCookie('theme').value == 'myLight' ? 'lighter-bg' : 'light-bg',
              'px-md-10 px-3 py-5',
            ]">
              <div class="right-border pr-3">
                <div class="text-body-1 font-weight-medium d-flex align-center">
                  <div class="ml-3" :style="`color:${useCookie('theme').value == 'myLight' ? '#000000DE' : '#EBEBEB'
                    }`">
                    یوزر ۱
                  </div>
                  <div dir="ltr" class="text-light-blue-lighten-2">@user1</div>
                </div>
                <div class="text-body-2 mt-3 rep-ans" :style="`color:${useCookie('theme').value == 'myLight' ? '#000000DE' : '#EBEBEB'
                  }`">
            ...
            <div class="px-md-10 py-md-7 pa-3">
              <div class="d-flex justify-space-between align-center">
                <div class="d-flex align-center">
                  <div class="">
                    <div class="d-flex align-center">
                      ...
                      <div class="mr-4" style="width: 200px; word-break: break-all; white-space: normal">
                        <div class="d-block d-md-flex" style="font-size: 1.2rem">
                          <div>پریا سهیلی</div>
                          <div class="text-light-blue-lighten-2 mr-md-6 mt-1 mt-md-0 text-md-left text-right"
                            style="font-size: 1.2rem" dir="ltr">
                            @user1
                          </div>
                        </div>
                      </div>
                    ...
                    <div>
                      <div class="d-sm-none mt-4 d-flex align-center">
                        ...
                        <div>
                          <v-btn flat :color="useCookie('theme').value == 'myLight'
                            ? '#F9FBFC'
                            : '#1e2124'
                            " :class="[
                              useCookie('theme').value == 'myLight'
              ...
              <div class="mt-3">
                <p class="text-body-1">
                  ...
                  متنوع با هدف بهبود ابزارهای کاربردی می باشدلورم ایپسوم متن ساختگی با
          ...
          <div class="d-flex mt-10">
            <img src="/public//icons/reply-fill.svg" alt="" width="32" height="32" />
            <div class="text-h5 pr-3">ارسال پاسخ</div>
          </div>

          <v-divider class="mt-5 mb-10 border-opacity-75" :thickness="2" color="#9e9e9e"></v-divider>
          ...
          <v-sheet :class="[
            ...
            <v-textarea hide-details variant="outlined" class="rounding mt-2"></v-textarea>
            ...
            <div class="text-left mt-10">
              <v-btn variant="flat" size="x-large" text="ثبت پاسخ" color="light-blue-lighten-2" flat class="rounding">
                <template v-slot:append>
                  <img src="/public/icons/reply-outline-black.svg" alt="">
                </template>
              </v-btn>
            </div>
          </v-sheet>
