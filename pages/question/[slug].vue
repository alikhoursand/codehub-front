<template>
  <div>
    ...
    <div class="mt-5 px-3">
      <v-card flat :class="[useCookie('theme').value == 'myLight' ? 'has-border' : 'no-border', 'question-card']">
    ...
    <div class="pt-15">
      <v-row class="ma-0 mt-15">
        ...
        <v-col cols="12" lg="9">
          <v-card v-for="q in 5" :key="q" flat
            :class="[useCookie('theme').value == 'myLight' ? 'has-border' : 'no-border', 'question-card']">
            <div v-if="q % 2 == 0"
              :class="[useCookie('theme').value == 'myLight' ? 'lighter-bg' : 'light-bg', 'px-md-10 px-3 py-5']">
