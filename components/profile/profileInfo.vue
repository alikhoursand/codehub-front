  ...
  <div>
    <div class=" editprofile-holder">
      <v-sheet
        ...
        <v-row class="ma-0">
          <v-col cols="12" lg="6" :class="[useCookie('theme').value == 'myLight' ? 'text-black' : 'text-white']">
          ...
          <v-col cols="12" lg="6" :class="[useCookie('theme').value == 'myLight' ? 'text-black' : 'text-white']">
            <span>ایمیل: </span>
            <span>test_user@test.com</span>
          </v-col>
          <v-col cols="12" class="text-left">
            <v-btn block @click="changePass()" class="rounding mt-5 d-flex d-lg-none" height="56" size="x-large"
      ...
      <v-sheet
        ...
        <v-row class="ma-0">
          <v-col cols="12" lg="6" :class="[useCookie('theme').value == 'myLight' ? 'text-black' : 'text-white']">
            ...
            <span>1376/02/02</span>
          </v-col>
          <v-col cols="12" lg="6" :class="[useCookie('theme').value == 'myLight' ? 'text-black' : 'text-white']">
            <span>حرفه یا شغل: </span>
            <span>کاربر تستی</span>
          </v-col>
      ...
      <v-sheet
        ...
        <v-row class="ma-0">
          ...
          <v-col cols="12" lg="6" :class="[useCookie('theme').value == 'myLight' ? 'text-black' : 'text-white']">
            <span>آدرس لینکدین: </span>
            <span>www.linkedin.com</span>
          </v-col>
          <v-col cols="12" lg="6" :class="[useCookie('theme').value == 'myLight' ? 'text-black' : 'text-white']">
            <span>آدرس تلکرام: </span>
            <span>09123456789</span>
          </v-col>
...
<script setup>
const emit = defineEmits(['editProfile', 'changePasswordEvent']);
