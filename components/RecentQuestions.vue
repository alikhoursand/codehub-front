<template>
  <div>
    <div class="d-flex justify-space-between align-center">
      ...
      <div>
        <v-btn text="مشاهده همه" class="" color="light-blue-lighten-2" flat variant="plain" :ripple="false"
          style="opacity: 1">
          <template v-slot:append>
            <img src="/icons/arrow-circle-left.svg" width="17" height="17" alt="" />
          </template>
        </v-btn>
      </div>
    </div>
    <v-row class="ma-0 mt-3">
      <v-col cols="12" lg="6" v-for="r in 4" :key="r">
        <v-card flat href="/question/test"
          ...
          <div class="pa-md-10 pa-3">
            ...
            <div class="mt-5">
              <p class="text-body-1 parag" v-if="r == 2">
